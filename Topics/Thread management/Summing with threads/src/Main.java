...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            summator1.join(); //summator2 не начнет работу, пока summator1 не завершит свою
        ...
        //Главный поток продолжит работу только после того, как 1 и 2 потоки завершат работу
        try {
            summator1.join();
            summator2.join();
        } catch (InterruptedException e) {
